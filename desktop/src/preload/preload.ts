...
const api: AifightBridgeApi = {
  ...
  getLiveMatchSnapshot: () => ipcRenderer.invoke(IPC.liveSnapshot),
  reconcileSessions: () => ipcRenderer.invoke(IPC.sessionsReconcile),
  ...
  acceptLegal: () => ipcRenderer.invoke(IPC.acceptLegal),
  ...
  onMatchEvents: (listener) => subscribe<MatchEventsPayload>(IPC.matchEvents, listener),
